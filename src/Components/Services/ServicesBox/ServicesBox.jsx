...
const ServicesBox = (props) => {
  return (
    <div className="serviceBox flex-col md:flex-row items-center justify-center w-[90%] md:w-[100%] mx-auto mb-[5px] md:mb-[25px] gap-[15px] md:gap-[30px]">
      {/*logo  */}
      <h1 className="text-[35px] md:text-[40px] text-[#00f7ff]">
        {props.icon}
      </h1>
      {/* text-section */}
      <div className="text-section text-center md:text-left">
        ...
        <div className="mx-auto md:ml-[1px] mt-[20px] rounded-[30px] py-1 px-3 flex items-center gap-[5px] bg-[#00f7ff] w-[100px] text-black hover:bg-black hover:text-[#00f7ff] hover:scale-95">
